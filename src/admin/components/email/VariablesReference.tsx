...
const variableDescriptions: Record<string, string> = {
  ...
  oldPriority: 'Previous priority (for priority change emails)',
  oldPriorityFormatted: 'Human-readable previous priority',
  newPriority: 'New priority (for priority change emails)',
  newPriorityFormatted: 'Human-readable new priority',
